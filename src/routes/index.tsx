...
// A single static noise texture, generated once on mount, whose opacity we
// fade based on scroll progress — cheap, and reads as "denoising" without
  ...
  useEffect(() => {
    const compute = () => {
      const els = document.querySelectorAll<HTMLElement>(
        "h1, h2, .marker, figcaption .font-bold, .paper-tab, figure figcaption",
      );
